...
public class EditDistance {
    ...
    public int minDistance(String word1, String word2) {
        ...
        try {
            ...
            result = iterative(word1, word2);
//            result = recursive(word1, word2);
            return result;
        } finally {
    ...
    private int recursive(String word1, String word2) {
        return findDistanceRecursively(word1, word2);
    }
    
    private int iterative(String word1, String word2) {
    	return findDistanceIteratively(word1, word2);
    }
    
    private int findDistanceIteratively(String s, String t) {
    	Integer[][] cache = new Integer[t.length() + 1][s.length() + 1];
    ...
    private int findDistanceRecursively(String s, String t) {
        if (s.length() == 0) {
            return t.length();
        } else if (t.length() == 0) {
            return s.length();
        ...
        if (Character.compare(s.charAt(0), t.charAt(0)) == 0) {
            // no edit
            value = findDistanceRecursively(s.substring(1), t.substring(1));
        } else {
            // edit
            String d = delete(s);
            String i = insert(t.charAt(0), s);
            String r = replace(t.charAt(0), s);
            Integer[] values = new Integer[] {findDistanceRecursively(r.intern(), t) /*replace*/, findDistanceRecursively(i.intern(), t)/*insert*/, findDistanceRecursively(d.intern(), t) /*delete*/};
            Arrays.sort(values);
            value = 1 + values[0];
        }
        cache.put(key, value);

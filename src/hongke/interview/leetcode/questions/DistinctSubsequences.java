...
public class DistinctSubsequences {
    ...
    public int numDistinct(String S, String T) {
        ...
        Integer[][] result = buildCache(S.toCharArray(), T.toCharArray());
        return result[S.length() - 1][T.length() - 1];
    }

    // The way how to build cache is initially proposed
    private Integer[][] buildCache(char[] s, char[] t) {
...
//    Recersive does not work due to stack overflow, see the test case below.
//    public int numDistinct(String S, String T) {
//        if (S == null || T == null || S.length() == 0 || T.length() == 0) {
//            return 0;
//        }
...
//        try {
//            result = findSequence (S.toCharArray(), 0, T.toCharArray(), 0);
//        } finally {
...
//    }
//
//    private int findSequence(char[] s, int i, char[] t, int j) {
//        List<Integer> key = Arrays.asList(new Integer[]{i,j});
//
...
//
//        int val = 0;
//        if (Character.compare(s[i], t[j]) == 0) {
//            val = findSequence(s, i+1, t, j+1) + findSequence(s, i+1, t, j);
//        } else {
//            val = findSequence(s, i+1, t, j);
//        }
//        cache.put(key, val);
//        return val;
//    }
...
//            return 0;
//        }
//        cache = new HashMap<Character, List<Integer>>();
//        char[] chars = S.toCharArray();
//        for (int i = 0;  i < chars.length; i++) {
//            if (!cache.containsKey(chars[i])) {
//                cache.put(new Character(chars[i]), new ArrayList<Integer>());
//            }
//            cache.get(chars[i]).add(i);
//        }
//
//        Set<List<Integer>> results = new HashSet<List<Integer>>();
//        char[] target = T.toCharArray();
//        for (int i = 0; i < target.length; i ++) {
//            if (!cache.containsKey(target[i])) {
//                return 0;
//            }
//            if (results.isEmpty()) {
//                for (Integer index : cache.get(target[i])) {
//                    List<Integer> result = new ArrayList<Integer>();
//                    result.add(index);
//                    results.add(result);
//                }
//            } else {
//                Set<List<Integer>> newResults = new HashSet<List<Integer>>();
//                for (Integer index : cache.get(target[i])) {
//                    for (List<Integer> result : results) {
//                        if (result.get(result.size() - 1) < index) {
...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(test.numDistinct("", "AC"));
        System.out.println(test.numDistinct("AB", ""));
        System.out.println(test.numDistinct(null, null));
        System.out.println(test.numDistinct("b", "a"));
        System.out.println(test.numDistinct("AB", "AD"));
        System.out.println(test.numDistinct("ABCC", "AC"));
        System.out.println(test.numDistinct("rabbbit", "rabbit"));
        System.out.println(test.numDistinct("aaa", "aa"));
    }

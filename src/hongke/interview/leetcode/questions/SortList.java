...
//    }
    ...
    public ListNode sortList(ListNode head) {
        ...
        Deque<ListNode> toMerge = new ArrayDeque<ListNode>();
        ...
        while (toMerge.size() > 1) {
            ListNode n1 = toMerge.poll();
            ListNode n2 = toMerge.poll();
            ListNode node = dummy;
    ...
    public static void main(String[] args) {
        ...
        ListNode.prettyPrint(test.sortList(input));
